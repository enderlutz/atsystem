...
const WORKFLOW_DEFINITIONS: WorkflowDef[] = [
  ...
  },
  {
    ...
    dot: "bg-red-500",
    chain: [],
    note: "No automation — owner reviews manually.",
  },
  {
    id: "wf-requote",
    title: "Re-quote Past Leads",
    dot: "bg-teal-500",
    chain: [],
    note: "No automation yet.",
  },
  {
    id: "wf-declined",
...
const STAGE_COLORS: Record<string, string> = {
  ...
  asking_address: "bg-purple-400",
  new_build: "bg-orange-300",
  needs_review: "bg-red-500",
  hot_lead: "bg-green-500",
  requote: "bg-teal-500",
  proposal_sent: "bg-emerald-500",
  no_package_selection: "bg-sky-500",
  package_selected: "bg-cyan-400",
  no_date_selected: "bg-yellow-500",
  date_selected: "bg-amber-500",
  deposit_paid: "bg-indigo-500",
  declined_estimate: "bg-rose-400",
  planning_future: "bg-blue-400",
  job_complete: "bg-violet-500",
...
export default function AutomationsPage() {
  ...
  const WORKFLOW_STAGES = [
    ...
    { value: "requote", label: "Re-quote Past Leads" },
    ...
    { value: "declined_estimate", label: "Declined Estimate" },
    { value: "planning_future", label: "Planning for future" },
