...
async def list_leads(
    ...
    list_fields = "id,ghl_contact_id,ghl_location_id,service_type,status,address,contact_name,contact_phone,contact_email,form_data,priority,urgency_level,kanban_column,customer_responded,customer_response_text,tags,created_at,archived"
